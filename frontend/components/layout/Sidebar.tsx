...
export function Sidebar() {
  ...
  const activeAlertCount = alertStats?.active_count || 0;
    ...
    <div className="h-screen w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        {filteredNavItems.map((item) => {
          ...
          const showBadge = isAlerts && activeAlertCount > 0;
          ...
          return (
            ...
            >
              ...
              {showBadge && (
                <span className="flex items-center justify-center h-5 min-w-[20px] px-1.5 text-xs font-bold rounded-full bg-red-600 text-white">
